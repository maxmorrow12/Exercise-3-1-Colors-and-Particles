...
func wobble():
	wobble_period += 1
	if wobble_amplitute > 0:
		var pos = wobble_direction * wobble_amplitute * sin(wobble_period)
		$Images.position = pos
		wobble_amplitute -= decay_wobble
